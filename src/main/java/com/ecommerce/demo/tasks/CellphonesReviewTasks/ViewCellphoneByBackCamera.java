package com.ecommerce.demo.tasks.CellphonesReviewTasks;

import com.ecommerce.demo.interactions.ProductReviewInteractions.CellphonesReviewInteractions.SelectCellphoneBrand;
import com.ecommerce.demo.interactions.ProductReviewInteractions.DeployProductCategory;
import net.serenitybdd.screenplay.Actor;
import net.serenitybdd.screenplay.Task;

import static com.ecommerce.demo.userinterfaces.Categories.CellphonesSubPage.*;

public class ViewCellphoneByBackCamera implements Task {

    private String brand;


    public ViewCellphoneByBackCamera(String brand) {
        this.brand = brand;

    }

    public static ViewCellphoneByBackCamera selectCamera(String brand) {
        return new ViewCellphoneByBackCamera(brand);
    }
