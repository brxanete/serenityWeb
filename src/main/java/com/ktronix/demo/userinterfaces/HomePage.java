...
public class HomePage {
    ...
    public static final Target BTN_MYACCOUNT = Target.the("BUTTON MY ACCOUNT").located(By.xpath("//span[@class='icon alk-icon-user']"));
    public static final Target BTN_LOGIN = Target.the("BUTTON LOGIN").located(By.xpath("(//span[text()='Iniciar sesión'])[1]"));
    public static final Target BTN_PROFILE = Target.the("BUTTON PROFILE").located(By.xpath("(//div[text()=' Mi Perfil'])[1]"));
